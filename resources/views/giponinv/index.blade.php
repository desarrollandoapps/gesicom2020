                                    ...
                                    <tbody>
                                        @foreach ($ponencias as $item)
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
                                                    <form action="{{route('gidepoau.create')}}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('GET')
                                                        <input type="hidden" name="dpponinv" value="{{$item->id}}">
                                                        <input type="hidden" name="dptippon" value="{{$item->picodtip}}">
